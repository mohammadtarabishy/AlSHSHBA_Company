<html lang=""><!-- To declare your language - read more here: https://www.w3.org/International/questions/qa-html-language-declarations --><head>
...
<div class="bgded overlay" style="background-image:url('../images/demo/backgrounds/01.png');">
    ...
    <section id="navwrapper" class="hoc clear">
        ...
        <nav id="mainav">
            ...
            <form action="#"><select><option selected="selected" value="">MENU</option><option value="../index.html">Home</option><option value="#">Pages</option><option value="gallery.html">- - Gallery</option><option value="full-width.html">- - Full Width</option><option value="sidebar-left.html">- - Sidebar Left</option><option value="sidebar-right.html">- - Sidebar Right</option><option value="basic-grid.html">- - Basic Grid</option><option value="font-icons.html">- - Font Icons</option><option value="#">Dropdown</option><option value="#">- - Level 2</option><option value="#">- - Level 2 + Drop</option><option value="#">- - - Level 3</option><option value="#">- - - Level 3</option><option value="#">- - - Level 3</option><option value="#">- - Level 2</option><option value="#">Link Text</option><option value="#">Link Text</option><option value="#">Link Text</option><option value="#">Long Link Text</option></select></form></nav>
        <!-- ################################################################################################ -->
        <div id="searchform">
            <div>
...
<script>
    $(document).ready(function () {
        var images = [
            "{{asset('images/demo/backgrounds/2.jpg')}}",
            "{{asset('images/demo/backgrounds/3.jpg')}}",
            "{{asset('images/demo/backgrounds/4.jpg')}}"
        ]
        var imageHead = document.getElementById("dev");
        var i = 0;
